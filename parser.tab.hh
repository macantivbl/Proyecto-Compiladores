  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_32_1 = 32,                             // $@1
        S_33_2 = 33,                             // $@2
        S_declaraciones = 34,                    // declaraciones
        S_declaracion = 35,                      // declaracion
        S_36_3 = 36,                             // $@3
        S_type = 37,                             // type
        S_funcion = 38,                          // funcion
        S_bloqueSentencias = 39,                 // bloqueSentencias
        S_sentencias = 40,                       // sentencias
        S_expresion = 41,                        // expresion
        S_condicion = 42,                        // condicion
        S_sentIf = 43,                           // sentIf
        S_44_4 = 44,                             // $@4
        S_45_5 = 45,                             // $@5
        S_46_6 = 46,                             // $@6
        S_sentElse = 47,                         // sentElse
        S_sentWhile = 48,                        // sentWhile
        S_49_7 = 49,                             // $@7
        S_50_8 = 50,                             // $@8
        S_51_9 = 51,                             // $@9
        S_52_10 = 52,                            // $@10
        S_sentAsig = 53,                         // sentAsig
        S_54_11 = 54,                            // $@11
        S_sentPutw = 55,                         // sentPutw
        S_56_12 = 56,                            // $@12
        S_sentPuts = 57,                         // sentPuts
        S_58_13 = 58,                            // $@13
        S_sentBreak = 59,                        // sentBreak
        S_60_14 = 60,                            // $@14
        S_sentencia = 61                         // sentencia
      };
    };
...
switch (yykind)
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_PUTS (location_type l)
      {
        return symbol_type (token::PUTS, std::move (l));
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_PUTW (location_type l)
      {
        return symbol_type (token::PUTW, std::move (l));
      }
#else
      static
      symbol_type
